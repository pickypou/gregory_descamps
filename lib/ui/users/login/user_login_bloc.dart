...
import 'package:gregory_descamps/ui/users/login/user_login_event.dart';
import 'package:gregory_descamps/ui/users/login/user_login_state.dart';
...
class UserLoginBloc extends Bloc<UserLoginEvent, UserLoginState> {
  ...
  UserLoginBloc(this.userInteractor, {required this.userId})
    ...
    on<FetchUserDataEvent>((event, emit) async {
      try {
        Map<String, dynamic> userData = await userInteractor.fetchUserData(
          userId,
        );
