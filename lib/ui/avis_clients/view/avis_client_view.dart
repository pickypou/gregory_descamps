...
class AvisClientsView extends StatefulWidget {
  final List<AvisClients> avis;

  const AvisClientsView({super.key, required this.avis});

  @override
  State<AvisClientsView> createState() => _AvisClientsViewState();
}

class _AvisClientsViewState extends State<AvisClientsView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Stack(
        children: [
          // Background image
          Positioned.fill(child: Opacity(opacity: imageOpacity)),
          ...
          Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children:
                    widget.avis.asMap().entries.map((entry) {
                      return Container(
                        width: 8.0,
                        height: 8.0,
